...
import { HttpResponseError } from "@/models/http.type";

const url = `${URL_API_BASE}/auth/forgot-password`;

export const resetPasswordService = async (data: ResetPasswordState) => {
  try {
