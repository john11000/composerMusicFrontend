...
export const InvoicesEditDialogReferences: React.FC<props> = ({
  getValues: getValuesGlobal,
}) => {
  ...
  useEffect(() => {
    ...
    if (watchAuxDrp) {
      const reference = References.find(
        (reference) => reference.id === parseInt(watchAuxDrp.value)
      );
      if (reference) {
        const group = Groups.find((group) => group.id === reference.groupId);
        const daysWarranty = CalculateWarrantyDays(
          getValuesGlobal("dateOfPurchase"),
          reference.warrantyDays
        );
  ...
  return (
    <Container>
      <form
        ...
        name="formReferences"
        noValidate
        onSubmit={handleSubmit(handleSubmitReferences)}
      >
        <Grid
          container
          spacing={2}
        ...
        >
              ...
              render={({
                ...
                <Autocomplete
                  ...
                  options={References.map(
                    (reference: IReferences, index: number) => {
                      return {
                        id: index,
                        value: reference.id.toString(),
                        label:
                          reference.referenceCode.toString() +
                          " - " +
                  ...
                  onChange={(_, newValue) => {
                    ...
                    setValue(
                      ...
                      References.filter(
                        (reference) =>
                          reference.id.toString() === newValue?.value ?? ""
                      )[0]?.publicPrice
                    );
                  }}
                  value={value || null}
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.referenceDescription?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                variant="outlined"
                size="small"
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.groupName?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                variant="outlined"
                size="small"
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.warrantyDays?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                variant="outlined"
                size="small"
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.quantity?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                variant="outlined"
                size="small"
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.serial?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                variant="outlined"
                size="small"
            ...
            <Controller
              ...
              render={({
                ...
                <Autocomplete
                  ...
                  clearOnEscape
                  sx={{ position: "relative", zIndex: 2 }}
                  options={departaments[watchDepartament?.id || 0]?.cities?.map(
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.neighborhood?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
                label="Barrio"
                variant="outlined"
          ...
          <Grid container item xs={12} md={6} spacing={1}>
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                <InputLabel id="street-or-carrera-label">
                  Tipo de Dirección
                </InputLabel>
                <Select
                ...
                <FormHelperText error={!!errorsLocal.typeLocation}>
                  {errorsLocal.typeLocation?.message}
                </FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={12} md={4}>
              <FormControl fullWidth>
                <TextField
                  ...
                  helperText={
                    errorsLocal.locationNumber && FIELD_REQUIRED_MESSAGE
                  }
                  label={
                    getValues("typeLocation")?.length < 5
                      ? "Calle"
                      : getValues("typeLocation")
                  }
                  variant="outlined"
                  size="small"
                  InputLabelProps={{
            ...
            <Grid item xs={12} md={5} sx={{ display: "flex" }}>
              <FormControl fullWidth>
                <TextField
                  ...
                  helperText={
                    errorsLocal.numberLocation && FIELD_REQUIRED_MESSAGE
                  }
                  label="#Numero"
                  variant="outlined"
                  size="small"
              ...
              <FormControl fullWidth>
                <TextField
                  ...
                  helperText={
                    errorsLocal.secondNumberLocation && FIELD_REQUIRED_MESSAGE
                  }
                  variant="outlined"
                  size="small"
                  InputLabelProps={{
          ...
          <Grid item xs={12} md={3}>
            <FormControl fullWidth>
              <TextField
                ...
                helperText={
                  errorsLocal.location?.type === "required" &&
                  FIELD_REQUIRED_MESSAGE
                }
