...
export const warrantyDays = (dateOfPurchase: string, warrantyDaysReference: number): number => {
  ...
  const warrantyRemaining = Math.max(warrantyDaysReference - daysSincePurchase, 0);
